...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Jeremias", "Montaño", "jeremiasmontano@gmail.com", "809 575 6245", "Charles de Gaulle ", "Admin");
            var customer = await CheckUserAsync("2020", "Jeremias", "Montaño", "jeremiasmontano@hotmail.com", "809 575 6245", "Calle Luna Calle Sol", "Customer");
